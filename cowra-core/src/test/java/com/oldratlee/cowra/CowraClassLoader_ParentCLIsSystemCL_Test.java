 ...
 * @author ding.lid
 */
public class CowraClassLoader_ParentCLIsSystemCL_Test {
    @BeforeClass
    public static void setUp() throws Exception {
        System.out.println("================================================");
        System.out.println("The classloader of JUnit: " + CowraClassLoader_ParentCLIsSystemCL_Test.class.getClassLoader());
        System.out.println("================================================");

        assertEquals(ClassLoader.getSystemClassLoader(), CowraClassLoader.class.getClassLoader());
    }
    ...
    public void test_NONE() throws Exception {
        ...
        delegateConfig.put(NONE, Arrays.asList(
                "com.foo.p1.*", CowraClassLoader_ParentCLIsSystemCL_Test.class.getPackage().getName() + ".*"));

        ClassLoader classLoader = new CowraClassLoader(new URL[]{lib_common}, delegateConfig);
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("(NONE) is forbidden by cowra config"));
        ...
        Class<?> clazz = classLoader.loadClass(CowraClassLoader_ParentCLIsSystemCL_Test.class.getName());
